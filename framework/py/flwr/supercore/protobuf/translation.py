...
PROTOBUF_REQUEST_TYPES: dict[RouteKey, type[Message]] = {
    ...
    ("POST", "/control/start-automation"): StartAutomationRequest,
    ("POST", "/control/list-automations"): ListAutomationsRequest,
    ("POST", "/control/stop-automation"): StopAutomationRequest,
